function createIcon(paths, defaultSize = 20) {
  return function Icon({ size = defaultSize, style, className, ...props }) {
    return (
      <svg
        width={size}
        height={size}
...
export const IconTask = createIcon(
...
export const IconGraduation = createIcon(
